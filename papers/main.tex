...
\section{Input data - stylised Belgian grid with a large amount of renewables}
...
\begin{table}
    ...
    \end{tabular}
    \caption{Analysis of model results when operating reserves are not included. UC = Unit Commitment constraints, DANet = Day Ahead Network constraints, PSCD = Prevent Simulataneous Charging and Discharging constraints.}
\end{table}
